<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
  <div class="container">
     <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{ Auth::check() ? route('statuses_path') : route('home') }}">DyT Mundosano</a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          @if($currentUser)
        <li class="dropdown">
            <a href="users_path" class="dropdown-toggle" data-toggle="dropdown">Usuarios<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
                <li>{{ link_to_route('register_path', 'Nuevo usuario') }}</li>
            </ul>
